...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative px-4 overflow-hidden">
      ...
      <div className="w-full max-w-2xl bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-8 flex flex-col items-center border-2 border-white/50 relative z-10">
